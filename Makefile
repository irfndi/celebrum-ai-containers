...
ci-pipeline: ## Run comprehensive CI pipeline (TypeScript + Go)
	...
	@echo "   - Cloudflare Workers: ✅ Verified (or skipped if Docker unavailable)"
	@echo "   - Docker Containers: ✅ Verified (or skipped if Docker unavailable)"
	@echo "   - Integration: ✅ Complete"

ci-no-docker: ## Run CI pipeline without Docker-dependent steps
	@echo "🚀 Starting CI Pipeline (No Docker)..."
	@echo "========================================"
	@echo "📦 Step 0: Installing Dependencies"
	@pnpm install --frozen-lockfile
	@echo "✅ Step 0: Dependencies Installed"
	...
	@echo "   - TypeScript Packages: All built and tested ✅"
	@echo "   - Go Services: All built and tested ✅"
	@echo "   - Docker-dependent steps: ⚠️  Skipped"
	@echo "   - Integration: ✅ Complete"
