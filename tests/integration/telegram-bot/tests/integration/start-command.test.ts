...
import { UserService, SessionService } from '../../../../../src/shared/src/services/index';
import type { User, NewUser } from '@celebrum-ai/db/schema';
import type { D1Database, KVNamespace } from '@cloudflare/workers-types';
import { getTestDb, createMockD1Database, createScenarioBasedTelegramApiMock } from '../../../../../src/shared/tests/utils/test-helpers';
...
describe('/start Command Implementation', () => {
  ...
  beforeEach(async () => {
    ...
    const { db, kv } = await getTestDb({ users: [{
    ...
    sessionService = new SessionService(mockKV as unknown as KVNamespace, 3600);
