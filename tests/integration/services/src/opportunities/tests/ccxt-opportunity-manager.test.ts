...
import type { MarketDataPoint } from '../../../../../../src/shared/src/infrastructure/data-sources';
...
import { OpportunityManager } from '../../../../../../src/services/src/opportunities/src/opportunity-manager';
import { CCXTDataSource } from '../../../../../../src/shared/src/infrastructure/ccxt-data-source';
import { User } from '../../../../../../src/shared/src/types';
import { ArbitrageDetector } from '../../../../../../src/services/src/opportunities/src/arbitrage-detector';
...
beforeEach(async () => {
  ...
  db = testContext.db;
  kv = testContext.kv as ExtendedKVNamespace & {
    get: ReturnType<typeof vi.fn>;
    put: ReturnType<typeof vi.fn>;
    delete: ReturnType<typeof vi.fn>;
    list: ReturnType<typeof vi.fn>;
...
describe('OpportunityManager - CCXT Integration', () => {
  ...
  beforeEach(() => {
    ...
    mockEnv.CELEBRUM_KV.get.mockImplementation((key: string, type?: string) => {
      if (type === 'json') {
    ...
    mockEnv.CELEBRUM_KV.put.mockResolvedValue(undefined);
    mockEnv.CELEBRUM_KV.delete.mockResolvedValue(undefined);
  ...
  describe('CCXT Primary Data Source', () => {
    ...
    it('should calculate arbitrage opportunities correctly from CCXT data', async () => {
      ...
      mockCcxtManager.getMultipleTickers.mockImplementation((symbols: string[]) => {
