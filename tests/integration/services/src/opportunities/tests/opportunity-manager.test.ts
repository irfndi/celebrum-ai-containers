...
import type { MarketData } from '../../../../../../src/shared/src/types/market';
import type { ArbitrageOpportunity } from '../../../../../../src/shared/src/types';
...
vi.mock('../../../../../../src/shared/src/infrastructure/data-sources', () => ({
  dataSourceManager: {
    getTicker: vi.fn()
  }
}));
...
vi.mock('../../../../../../src/shared/src/infrastructure/ccxt-data-source', () => {
...
const createMockMarketData = (price: number, volume: number = 1000000): MarketData => ({
  symbol: 'BTCUSDT',
  price,
  volume,
...
describe('OpportunityManager', () => {
  ...
  beforeAll(async () => {
    ...
    const opportunityManagerModule = await import('../../../../../../src/services/src/opportunities/src/opportunity-manager');
    const dataSourceModule = await import('../../../../../../src/shared/src/infrastructure/data-sources');
    const ccxtDataSourceModule = await import('../../../../../../src/shared/src/infrastructure/ccxt-data-source');
  ...
  beforeEach(async () => {
    ...
    const { db, kv: kvMock } = await getTestDb();
    kv = kvMock as ExtendedKVNamespace & {
      get: ReturnType<typeof vi.fn>;
      put: ReturnType<typeof vi.fn>;
      delete: ReturnType<typeof vi.fn>;
      list: ReturnType<typeof vi.fn>;
    ...
    kv.get.mockImplementation((key: string, type?: string) => {
      if (type === 'json') {
