...
import type { HedgeOpportunity, HedgeExecutionResult } from '../../../../../../src/services/src/opportunities/src/opportunity-manager';
...
describe('HedgeOpportunityManager', () => {
  ...
  beforeEach(async () => {
    ...
    // Create a simple in-memory store for KV operations
    const kvStore = new Map<string, any>();
    
    // Override KV methods to use the in-memory store
