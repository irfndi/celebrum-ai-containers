...
exports.router = exports.ServiceRouter = void 0;
...
class ServiceRouter {
     ...
     */
    telegramBotHandler(handleTelegramUpdate) {
        const telegramApp = new hono_1.Hono();
     ...
     */
    discordBotHandler() {
        const discordApp = new hono_1.Hono();
     ...
     */
    adminHandler() {
        const adminApp = new hono_1.Hono();
...
exports.router.route('/telegram', serviceRouter.telegramBotHandler());
// Mount the API handler
exports.router.route('/api', serviceRouter.apiHandler());
// Mount the admin handler
exports.router.route('/admin', serviceRouter.adminHandler());
// Mount the discord handler
exports.router.route('/discord', serviceRouter.discordBotHandler());
// Health check endpoint
exports.router.get('/health', (c) => {
    return c.json({
        status: 'healthy',
        timestamp: new Date().toISOString(),
